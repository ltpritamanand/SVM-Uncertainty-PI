...
# selectors.py lives at final_github/shared/src_utils/feature_selection/
...
def main():
    ...
    train_data = pd.read_csv(_DATASETS_DIR / "MADELON" / "madelon_train.data", header=None, delim_whitespace=True)
    train_labels = pd.read_csv(_DATASETS_DIR / "MADELON" / "madelon_train.labels", header=None, delim_whitespace=True)
